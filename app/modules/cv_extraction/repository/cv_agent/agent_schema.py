...
class PersonalInfoItem(BaseModel):
    ...
    portfolio_url: Optional[str] = Field(
        None, description="URL to personal portfolio or website."
    )
    ...
    address: Optional[str] = Field(
        None, description="Physical address or location (city, country)."
    )
...
class EducationItem(BaseModel):
    ...
    degree_name: Optional[str] = Field(
        None, description="Degree obtained (e.g., Bachelor of Science, Master of Arts)."
    )
    ...
    relevant_courses: Optional[List[str]] = Field(
        default_factory=list, description="List of relevant courses taken."
    )
...
class WorkExperienceItem(BaseModel):
    ...
    start_date: Optional[str] = Field(
        None, description="Start date of employment (e.g., YYYY-MM)."
    )
    end_date: Optional[str] = Field(
        None, description="End date of employment (e.g., YYYY-MM, or 'Present')."
    )
    duration: Optional[str] = Field(
        None, description="Calculated or stated duration of employment."
    )
    ...
    location: Optional[str] = Field(
        None, description="Location of the employment (city, country)."
    )
...
class ProjectItem(BaseModel):
    ...
    role: Optional[str] = Field(
        None, description="Your role or contribution to the project."
    )
    ...
    end_date: Optional[str] = Field(
        None, description="End date of the project or if it's ongoing."
    )
...
class CertificateItem(BaseModel):
    ...
    issuing_organization: Optional[str] = Field(
        None, description="Organization that issued the certificate."
    )
    issue_date: Optional[str] = Field(
        None, description="Date the certificate was issued (e.g., YYYY-MM)."
    )
    expiration_date: Optional[str] = Field(
        None, description="Expiration date, if applicable (e.g., YYYY-MM)."
    )
    credential_id: Optional[str] = Field(
        None, description="Credential ID or link for verification."
    )
...
class InterestItem(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Brief description or details about the interest."
    )
...
class ListKeywordItem(BaseModel):
    ...
    items: List[KeywordItem] = Field(
        default_factory=list, description="A list of keywords."
    )
...
class InferredCharacteristicItem(BaseModel):
    ...
    statement: str = Field(
        ..., description="The inferred statement or insight about the candidate."
    )
...
class CVAnalysisResult(BaseModel):
    ...
    raw_cv_content: Optional[str] = Field(
        None, description="The original CV content provided by the user."
    )
    ...
    personal_information: Optional[PersonalInfoItem] = Field(
        None, description="Extracted personal and contact details."
    )
    ...
    skills_summary: Optional[ListSkillItem] = Field(
        default_factory=ListSkillItem, description="List of extracted skills."
    )
    ...
    cv_summary: Optional[str] = Field(
        None, description="A brief, LLM-generated summary of the entire CV."
    )
...
class CVState(TypedDict):
    ...
    raw_cv_content: Optional[
        str
    ]  # Initial input from user/service (Output of InputHandlerNode to ParserNode)
    processed_cv_text: Optional[str]  # Cleaned CV text (Output of ParserNode)

    # Section identification
    identified_sections: Optional[
        List[str]
