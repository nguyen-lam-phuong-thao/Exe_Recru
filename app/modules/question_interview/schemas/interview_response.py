...
class InterviewAnswerEvaluationResponse(ResponseSchema):
	"""Response for evaluating a single interview answer."""
	score: float = Field(..., ge=0.0, le=1.0, description="The evaluation score, ranging from 0.0 to 1.0")
